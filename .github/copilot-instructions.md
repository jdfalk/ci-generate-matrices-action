...
- All changes to matrix generation logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that generates CI test matrices based on repository structure.
